...
import com.lic.licenta.repository.Role;
...
public class AuthenticationService {
    ...
    public User signup(RegisterUserDto input) {
        ...
        if (input.getEmail().equals("sebialex877@yahoo.com")) {
            userRole = Role.ADMIN;
        }
    ...
    public boolean changeUserPassword(String username, ChangePasswordDto changePasswordDto) {
        ...
        boolean isOldPasswordCorrect = passwordEncoder.matches(changePasswordDto.getOldPassword(), user.getPassword());
